...
const solutions = [
  ...
  "Automotive Parts & Accessories Businesses",
  "EV Manufacturers & Dealers",
  "Vehicle Rental & Fleet Companies",
];
  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          {/* ===== CONTENT WITH MORE SPACE FOR CAR ===== */}
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.4fr] gap-8 items-center p-6 md:p-8 lg:p-10 relative z-10">
            {/* Left: text + list - Compact */}
            <motion.div
